...
public class RunTest {
	...
	public void pageLogin(String Travelopt,String passCount,String fromPort,String fromMonth,String fromDay,String toPort,String toMonth,String toDay,String servClass,String airline,String totalPrc,String fname,String lname, String fname1,String lname1,String fname2,String lname2,String fname3,String lname3) throws InterruptedException{
		...
		//total price
		 ...
		 String oneWay=  driver.findElement(By.cssSelector("table:nth-child(1) tbody:nth-child(1) tr:nth-child(3) td.data_center > font:nth-child(1)")).getText();
		System.out.println("price for Oneway: "+ oneWay);
		int result1 = Integer.parseInt(oneWay);
		String roundPrice = driver.findElement(By.cssSelector("table:nth-child(1) tbody:nth-child(1) tr:nth-child(6) td.data_center > font:nth-child(1)")).getText();
		...
		String tax = driver.findElement(By.cssSelector("table:nth-child(1) tbody:nth-child(1) tr:nth-child(8) td.data_left:nth-child(2) > font:nth-child(1)")).getText();
		...
		String totalPrice = driver.findElement(By.cssSelector("tbody:nth-child(1) tr:nth-child(9) td.data_left:nth-child(2) font:nth-child(1) > b:nth-child(1)")).getText();
